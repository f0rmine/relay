export const messages = {
  en: {
    ...
    api: {
      ...
      errors: {
        ...
        filenameTooLong: 'The filename is too long',
        invalidFilename: 'The filename contains invalid characters',
  ...
  uk: {
    ...
    chat: {
      ...
      queued: 'у черзі',
      failed: 'помилка',
      retry: 'Спробувати надіслати ще раз',
      removeFailed: 'Видалити невдале повідомлення',
    ...
    api: {
      ...
      errors: {
        ...
        filenameTooLong: 'Назва файлу задовга',
        invalidFilename: 'Назва файлу містить недопустимі символи',
